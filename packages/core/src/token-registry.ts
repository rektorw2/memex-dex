 ...
 *
 * Три группы: акции, крупные криптоактивы, бренды. Список неполон
 * и таким останется — он ловит частое. Полнота недостижима, а ложное
...
export const PROTECTED_SYMBOLS = new Set([
  ...
  'GME', 'AMC', 'PLTR', 'BABA', 'DIS', 'JPM', 'SNDK', 'IPO',
