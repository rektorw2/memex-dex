...
export const SMOKE_EXIT = {
  ...
  channelDenied: 8,
  /**
   * Проверка не завершена: ошибки нет, но и подтверждения нет —
   * не хватило доступа, времени или событий. Не успех.
   */
  incomplete: 9,
} as const;
...
export const OKX_ERROR_MEANING: Record<string, string> = {
  ...
  '60036': 'Код отсутствует в документации OKX WebSocket; наблюдался в потоке кошельков, к доступу к Signal не относится — нужен разбор по журналу',
};
