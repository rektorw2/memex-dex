 ...
 *   10 — отсутствие токена в detail-индексах стало замечанием, а не
 *        приговором: OKX hot-list и detail-маршрут расходятся во
 *        времени. Неудавшаяся покупка через один агрегатор больше
 *        не выдаётся за доказательство невозможной продажи.
 */
