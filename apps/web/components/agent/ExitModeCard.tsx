...
export const EXIT_MODE_COPY: ExitModeCopy[] = [
  ...
  { key: 'TRAILING', label: 'Трейлинг', tag: 'тело + прибыль + трейлинг', art: 'trailing', summary: 'Фиксация тела на 2× сохраняется. На 3× фиксируем 50%, остаток ведём по трейлингу. Это половина оставшихся токенов; до 2× стоп −50% от входа.', chips: ['50% исходного на 2×', '50% остатка на 3×', 'трейлинг −50%', 'до 6 ч'] },
  { key: 'TRAILING_PURE', label: 'Чистый трейлинг', tag: 'сопровождение с входа', art: 'trailing-pure', summary: 'Трейлинг −50% от максимума действует с входа. Фиксация тела на 2× сохраняется. На 3× фиксируем 50%, остаток ведём по трейлингу — продаётся половина остатка.', chips: ['трейлинг с входа', '50% исходного на 2×', '50% остатка на 3×', 'до 6 ч'] },
];
